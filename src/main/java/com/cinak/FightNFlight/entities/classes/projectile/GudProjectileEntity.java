...
public abstract class GudProjectileEntity extends Entity {
    public UUID ownerUUID;
    public int ownerNetworkId;
    public boolean leftOwner;

    GudProjectileEntity(EntityType<? extends GudProjectileEntity> p_i231584_1_, World p_i231584_2_) {
        super(p_i231584_1_, p_i231584_2_);
    }
    public  void onGotHit(RayTraceResult result)
    {
        RayTraceResult.Type type = result.getType();
        if (type == RayTraceResult.Type.BLOCK)
        {
            final BlockRayTraceResult brtr = (BlockRayTraceResult) result;
            onBlockHits(brtr.getBlockPos(), brtr.getDirection());
        }
        else if (type == RayTraceResult.Type.ENTITY) onEntityHits(((EntityRayTraceResult) result).getEntity());
    }

    public void onBlockHits(BlockPos blockPos, Direction direction){

    }
    public void onEntityHits (Entity entity)
    {
    }
    ...
    public void setOwner(@Nullable net.minecraft.entity.Entity p_212361_1_) {
        if (p_212361_1_ != null) {
    ...
    public boolean checkLeftOwner() {
        ...
        if (entity != null) {
            for(net.minecraft.entity.Entity entity1 : this.level.getEntities(this, this.getBoundingBox().expandTowards(this.getDeltaMovement()).inflate(1.0D), (p_234613_0_) -> {
    ...
    public void shootFromRotation(net.minecraft.entity.Entity p_234612_1_, float p_234612_2_, float p_234612_3_, float p_234612_4_, float p_234612_5_, float p_234612_6_) {
    ...
    protected boolean canHitEntity(net.minecraft.entity.Entity p_230298_1_) {
