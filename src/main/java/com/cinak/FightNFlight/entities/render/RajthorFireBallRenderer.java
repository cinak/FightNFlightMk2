...
@OnlyIn(Dist.CLIENT)
public class RajthorFireBallRenderer extends EntityRenderer<RajthorFireBallEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(FightNFlight.MOD_ID, "textures/items/rajthor_charge.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public RajthorFireBallRenderer(EntityRendererManager p_i46553_1_) {
        super(p_i46553_1_);
    }

    protected int getBlockLightLevel(RajthorFireBallEntity p_225624_1_, BlockPos p_225624_2_) {
        return 15;
    }

    public void render(RajthorFireBallEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public ResourceLocation getTextureLocation(RajthorFireBallEntity p_110775_1_) {
