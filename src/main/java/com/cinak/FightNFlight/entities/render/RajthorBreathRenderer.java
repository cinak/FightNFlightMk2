...
@OnlyIn(Dist.CLIENT)
public class RajthorBreathRenderer extends EntityRenderer<RajthorBreathEntity> {
    ...
    public RajthorBreathRenderer(EntityRendererManager p_i46553_1_) {
        super(p_i46553_1_);
    }

    protected int getBlockLightLevel(RajthorBreathEntity p_225624_1_, BlockPos p_225624_2_) {
        return 15;
    }

    public void render(RajthorBreathEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public ResourceLocation getTextureLocation(RajthorBreathEntity p_110775_1_) {
